...
#Retorna a Matriz de transformacao Homogenea usando como entrada os parametros de DH
...
for v in range(1000):
    ...
    ox_0 = np.array([o,o1_0,o2_0])
    #os vetores z serao transformados em vetores linhas, para poder ser usado a funcao np.cross
    z0_0 = v_3d(k).T
    z1_0 = v_3d(A1@k).T
    z2_0 = v_3d(A1@(A2@k)).T
    ...
    aux2 = aux2.T
    q = q - c*v_3d(aux2@f)
    #print(distancia(o3_0,destino,3),'\n')
    ax.clear()
