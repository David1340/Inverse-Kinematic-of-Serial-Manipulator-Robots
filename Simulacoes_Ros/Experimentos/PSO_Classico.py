...
def PSO(o,o2,number,n,L):
    ...
    #print(f)
    return [qbest,convergiu,iteracoes]
...
for cont in range(10):
    ...
    while not rospy.is_shutdown():
        solucao, convergiu, iteracoes = PSO(posicaod,orientd,numero_particulas,dimensao,L)    
        break
    if(convergiu == 1):
        iteracao_total = iteracao_total + iteracoes
    vezes = vezes + convergiu
    print(cont)

print('convergiu: ',vezes)
print('media de iteração: ',iteracao_total/vezes)
