#Este código é baseado na figura 1.16 do livro do Spong
...
distancia2 = float(input('Digite o valor da junta 2: ')) 
distancia3 = float(input('Digite o valor da junta 3: '))
...
#Legendas
plt.legend(['Elo 1','Elo 2','','Junta 1 (Revolucao)', 'Junta 2 (Revolucao)'\
