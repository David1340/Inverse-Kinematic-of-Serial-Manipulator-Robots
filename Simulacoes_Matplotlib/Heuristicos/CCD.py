...
plot(q,destino)
plt.plot([destino[0,0],pontos[0,5]],[destino[1,0],pontos[1,5]],[destino[2,0],pontos[2,5]],'red')
plt.plot([pontos[0,5],pontos[0,8]],[pontos[1,5],pontos[1,8]],[pontos[2,5],pontos[2,8]],'green')
